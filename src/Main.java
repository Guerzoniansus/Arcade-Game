...
public class Main extends JFrame implements KeyListener {
	...
	public static Timer obstacleTimer, timerScore;
	...
	public static void setupTimers() {
		...
		/*
		 * Was just trying different things, I wasn't sure what the best way to do it was and this code is a bit unfinished
		 * 
		 ...
		 * 
		 * BUGS: I mostly faced the problem of how to make it so when I "restart" the game you don't end up with a new instance of the timer while the same timers from last game are still running
		 * 
		 */
		...
		/*
		 * final TimerTask obstacleTimerTask = new TimerTask() { public void run() { if (isAlive) {
		 * 
		 * Obstacle obstacle = new Obstacle(currentSpeed); obstacles.add(obstacle);
		 * 
		 * obstacleTimer.cancel(); obstacleTimer.schedule(obstacleTimerTask, currentTime);
		 * 
		 * } else {
		 * 
		 * } } };
